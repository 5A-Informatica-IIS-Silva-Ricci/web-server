...
<div v-scope class="z-40 w-100 h-screen p-8 flex justify-center items-center flex-col">
    ...
    <div class="flex justify-center items-center flex-wrap">
        <div class="ring-2 ring-sky-500 min-w-[15rem] py-8 m-8 flex justify-center items-center flex-col g-white shadow-sm rounded-lg text-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:highlight-white/5">
    ...
    <a href="/web-service" class="absolute bottom-6 right-6 md:top-2 md:bottom-auto md:right-auto md:left-10 mt-8 rounded-2xl py-3 px-3 g-white ring-1 ring-slate-900/10 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 shadow-sm rounded-lg text-slate-600 dark:bg-slate-800 dark:ring-0 dark:text-slate-300 dark:highlight-white/5 dark:hover:bg-slate-700">
